...
<head>
	...
	<title>aliultraBLOG</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	<meta name="description" content="aliultra WEBLOG" />
	<meta name="keywords" content="aliultra, ali, reza, alireza, shaemi, ultra, ultram, شائمی ,علیرضا" />
	<meta name="author" content="alirezaSHAEMI" />
		...
		<header class="header">
			...
			<div class="top-menu">
				<ul>
					...
					<li>
						<a target="_blank" href="https://telegram.me/aliultra">
							<span class="icon la la-send"></span>
							<span class="link">Telegram</span>
						</a>
					</li>
					<li>
						<a target="_blank" href="https://instagram.com/aliultram">
							<span class="icon la la-instagram"></span>
							<span class="link">Instagram</span>
						</a>
					</li>
					<li>
						<a target="_blank" href="https://twitter.com/aliultram">
							<span class="icon la la-twitter"></span>
			...
			<div class="card-inner card-started active" id="home-card">
				...
				<div class="centrize full-width">
					<div class="vertical-center">
						...
						<!-- Started titles -->
						<div class="title"><span>4</span>04</div>
						<div class="subtitle">
							This Page 
							...
							<div class="row fuct-items">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										...
										<div class="name">5000+ Tracks Listened</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										...
										<div class="name">4 Awards Won</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										...
										<div class="name">4 Projects Completed</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										<div class="icon"><i class="la la-youtube"></i></div>
										<div class="name">10,000 Youtube views recorded</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										...
										<div class="name">30+ Books Readed</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										...
										<div class="name">5000 Lines of Code Written</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										<div class="icon"><i class="la la-play"></i></div>
										<div class="name">4 Professional Edits Done</div>
									</div>
								</div>
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="fuct-item card-box">
										<div class="icon"><i class="la la-photo"></i></div>
										<div class="name">18 Logos Made</div>
									</div>
								</div>
						...
						<div class="content clients">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									...
									<!-- title -->
									<div class="title"><span>Favorite</span> Singers</div>
							...
							<div class="row client-items">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/0u4qrFczDmAsJesHPgbnru?si=ta7kCkCoTFKYyRRsRmPzOQ&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/5aWL79DpD45MzDMwCTZqsN?si=ct9KMBxiSvKUknIelGPpug&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/5er043agmHdVZkWTxL0Lpk?si=kg5quM84T8mf8BBm6uQ_Cw&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/1l8pQbuaP7I1jEI6g6Jnfu?si=CHRvQkyFQam1XsT0N2ZTmQ&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/2X90kCLyxyPeJ5nynJGbvT?si=3suFjUPHTiK3FESRlfhyKg&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/7dGJo4pcD2V6oG8kP0tJRR?si=EtEjVU6UTEigrzAC0j_AGA&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/5vVveQB8n4kETe67waTS3t?si=oc0qDS1UTxKBZOF9FkO1rA&dl_branch=1">
								...
								<div class="col col-m-6 col-t-6 col-d-3 col-d-lg-3">
									<div class="client-item card-box">
										<div class="image">
											<a target="_blank" href="https://open.spotify.com/artist/1PgsdK1Ll4oK28g6KLPOg1?si=4AA7l7ybTwyILJMcOSA5Ag&dl_branch=1">
						...
						<div class="content inner-top">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									...
									<div class="text">
										<p>
											<strong>Hello, I’m Alireza Shaemi</strong>, I'm Programming Lover. <br />
											I am good at <strong>html, css, wordpress, python.</strong>
										</p>
									</div>
									<div class="circle-bts">
										<a href="https://telegram.me/aliultram"><span><i class="icon la la-send"></i>Telegram Message</span></a>
										<a href="https://instagram.com/aliultram"><i class="icon la la-instagram"></i></a>
										<a href="https://twitter.com/aliultram"><i class="icon la la-twitter"></i></a>
										<a href="https://github.com/aliultra"><i class="icon la la-github"></i></a>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									...
									<div class="contact_form card-box">
										<form method="post" action="tele.php">
											...
											<input class="button" onclick="$('#cform').submit()" type="submit" value="Send Message">
											</div>
